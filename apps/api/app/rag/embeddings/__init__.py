...
from app.rag.embeddings.gemini import (
...
def build_embedding_provider(settings: Settings) -> EmbeddingProvider:
    ...
    if provider_name == "gemini":
        return GeminiEmbeddingProvider(
            ...
            model_name=settings.rag_embedding_model or GEMINI_EMBEDDING_MODEL,
            dimensions=settings.rag_embedding_dimensions or GEMINI_EMBEDDING_DIMENSIONS,
