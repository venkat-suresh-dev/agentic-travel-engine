...
def example_attraction_search() -> AttractionSearchResult:
    return AttractionSearchResult(
        ...
        attractions=[
            ...
            AttractionPlace(
                place_id="places/mosque",
                name="Jumeirah Mosque",
                address="Jumeirah",
                latitude=25.2340,
                longitude=55.2600,
                primary_type="place_of_worship",
                rating=4.8,
                user_rating_count=3500,
            ),
            AttractionPlace(
                place_id="places/marina",
    ...
    return RestaurantSearchResult(
        ...
        restaurants=[
            RestaurantPlace(
                ...
                price_level=RestaurantPriceLevel.EXPENSIVE,
            ),
            RestaurantPlace(
                ...
                price_level=RestaurantPriceLevel.INEXPENSIVE,
            ),
            RestaurantPlace(
                place_id="places/restaurant-c",
                name="Restaurant C",
                address="Al Fahidi",
                latitude=25.2640,
                longitude=55.2960,
                ...
                price_level=RestaurantPriceLevel.MODERATE,
            ),
            RestaurantPlace(
                place_id="places/restaurant-d",
                name="Restaurant D",
                address="Jumeirah",
                latitude=25.2100,
                longitude=55.2500,
    ...
    return HotelSearchResult(
        ...
        hotels=[
            ...
            HotelOffer(
                ...
                latitude=25.0770,
                longitude=55.1390,
                total_price=MoneyAmount(amount=Decimal("3200"), currency="INR"),
            ),
        ],
    )
